...
- Prices: Basic (`MELODY`) 119,000 VND; Premium (`VOICE`) 159,000 VND; Signature 199,000 VND. Shipping is 30,000 VND per shipment. Twin second copy is 75% of the configured first-copy amount. Prices must be data/config driven, versioned, and snapshotted onto an order.
