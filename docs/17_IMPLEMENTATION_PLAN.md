...
2. **Canonical data/auth:** Supabase migrations/RLS, profiles, guest sessions, projects/revisions/checkpoints/assets; Google-only checkout auth; all-draft idempotent claim.
...
5. **Pricing/checkout:** versioned pricing/quotes, immutable snapshot/order/shipment model, secure Google-gated checkout and safe tracking.
